    ...
    horseBlocks.forEach((block, blockIndex) => {
      ...
      try {
        ...
        if (!jockey) {
          ...
          // 有名騎手名のリストで直接検索
          const allJockeys = [
            'ルメール', 'クリストフ', '川田', '武豊', '武', '戸崎', '横山武', '横山和', '横山',
            '松山', '松岡', '坂井', '池添', '岩田康', '岩田望', '岩田', '藤岡', '藤懸', '田辺', '三浦', 
            '和田', '幸', '菅原', '団野', '西村', '鮫島', '菱田', '津村', '大野', 
            '北村', '佐々木', '黛', '鷲頭', '福永', 'デムーロ', '内田博', '内田', '木幡',
            '石神', '石橋', '丸田', '柴田', '武士沢', '江田', '勝浦', '丸山', 
            '蛯名', '吉田隼', '吉田豊', '吉田', '野中', '木幡育', '木幡巧', '小野寺', 
            '宮崎', '原田', '原', '岡田', '岡部', '荻野', '川須', '菊沢', '小崎', '富田', '浜中',
            '太宰', '藤田', '中井', '秋山', '嘉藤', 
